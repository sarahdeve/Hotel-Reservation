            ...
            <div className="lsItem">
              ...
              <label htmlFor="">Options</label>
                ...
                <div className="lsOptionItem">
                  ...
                  <input type="number" onChange={e=>setMin(e.target.value)} min={1} className='lsOptionInput' />
                </div>
                <div className="lsOptionItem">
                  <span className="lsOptionText">Max Price <small>per night</small></span>
                  <input type="number" onChange={e=>setMax(e.target.value)} min={1} className='lsOptionInput' />
                </div>
                <div className="lsOptionItem">
